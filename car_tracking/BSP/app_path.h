...
/* 区域状态机函数 */
void APP_AreaStateMachine_Init(AreaType_t initial_area, uint8_t threshold, uint32_t min_interval);
uint8_t APP_Update_AreaStateMachine(void);
AreaType_t APP_Get_CurrentArea(void);
